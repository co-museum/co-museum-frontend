...
const OurOfferingPreSaleInProgressConnected = ({item, canRedeem}) => {
    ...
    return <>
        ...
        <Grid item xs={12}>
            <Button disabled={!canRedeem} variant={'outlined'} className={'full-size-button black-white-button btn-md w-100 font-20'} onClick={() => {}}>{strings.ourOfferings.RedeemNFTs}</Button>
        </Grid>
        <Grid item md={6} xs={5}>
...
export default OurOfferingPreSaleInProgressConnected;