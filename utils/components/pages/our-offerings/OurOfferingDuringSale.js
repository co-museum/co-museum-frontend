...
const OurOfferingDuringSale = ({item}) => {
    ...
    const buyTokenPackages = () => {
        initDialog({
            ...
            description: strings.ourOfferings.choosePackage,
    ...
    return <>
        ...
        <Grid item xs={12} md={6}>
            <Box className={'box-grey-1 token-price p-m-0-m'}>
                <div className="mt-0-m">
        ...
        <Grid item xs={12}>
            <Box className={'box-grey-1 p-m-0-m br-b-0-m'}>
                <div className="mt-0-m">
                    <Typography className={'font-16'}>{strings.ourOfferings.percentageOfTokensSold} <QuestionMark/> <span className={'font-12 float-right'}>{item.percent} of {item.percentOf}</span></Typography>
                    <Slider className={'percentage-slider'} defaultValue={item.percentageOfTokensSold} step={10} min={0} max={100} disabled />
                </div>
            </Box>
        </Grid>
        <Grid item xs={12}>
            <Button variant={'outlined'} className={'full-size-button black-white-button btn-md w-100 font-20'} onClick={buyTokenPackages}>{strings.ourOfferings.tokenPackages}</Button>
        </Grid>
        <Grid item md={6} xs={5}>
